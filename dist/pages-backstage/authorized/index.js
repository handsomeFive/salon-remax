...
module.exports = {"body":"body___2UBW1","title":"title___4McFb","label":"label___1OC8a","input":"input___183yO","loginBox":"loginBox___3sPId","btn":"btn___7wwVm"};
...
bytesToString:function bytesToString(bytes){for(var str=[],i=0;i<bytes.length;i++){str.push(String.fromCharCode(bytes[i]));}return str.join('');}}};module.exports=charenc;
...
/* istanbul ignore next */
/* WEBPACK VAR INJECTION */(function(Buffer) {(function(){var crypt=__webpack_require__(70),utf8=__webpack_require__(39).utf8,bin=__webpack_require__(39).bin,// The core
sha1=function sha1(message){// Convert to byte array
...
var m=crypt.bytesToWords(message),l=message.length*8,w=[],H0=1732584193,H1=-271733879,H2=-1732584194,H3=271733878,H4=-1009589776;// Padding
m[l>>5]|=0x80<<24-l%32;m[(l+64>>>9<<4)+15]=l;for(var i=0;i<m.length;i+=16){var a=H0,b=H1,c=H2,d=H3,e=H4;for(var j=0;j<80;j++){if(j<16)w[j]=m[i+j];else{var n=w[j-3]^w[j-8]^w[j-14]^w[j-16];w[j]=n<<1|n>>>31;}var t=(H0<<5|H0>>>27)+H4+(w[j]>>>0)+(j<20?(H1&H2|~H1&H3)+1518500249:j<40?(H1^H2^H3)+1859775393:j<60?(H1&H2|H1&H3|H2&H3)-1894007588:(H1^H2^H3)-899497514);H4=H3;H3=H2;H2=H1<<30|H1>>>2;H1=H0;H0=t;}H0+=a;H1+=b;H2+=c;H3+=d;H4+=e;}return[H0,H1,H2,H3,H4];},// Public API
api=function api(message,options){var digestbytes=crypt.wordsToBytes(sha1(message));return options&&options.asBytes?digestbytes:options&&options.asString?bin.bytesToString(digestbytes):crypt.bytesToHex(digestbytes);};api._blocksize=16;api._digestsize=20;module.exports=api;})();
 ...
 * @license  MIT
 */ /* eslint-disable no-proto */var base64=__webpack_require__(67);var ieee754=__webpack_require__(68);var isArray=__webpack_require__(69);exports.Buffer=Buffer;exports.SlowBuffer=SlowBuffer;exports.INSPECT_MAX_BYTES=50;/**
...
/* istanbul ignore next */
(function(){var base64map='ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/',crypt={// Bit-wise rotation left
...
base64=base64.replace(/[^A-Z0-9+\/]/ig,'');for(var bytes=[],i=0,imod4=0;i<base64.length;imod4=++i%4){if(imod4==0)continue;bytes.push((base64map.indexOf(base64.charAt(i-1))&Math.pow(2,-2*imod4+8)-1)<<imod4*2|base64map.indexOf(base64.charAt(i))>>>6-imod4*2);}return bytes;}};module.exports=crypt;})();
...
var sha1 = __webpack_require__(45);
...
var ling = __webpack_require__(102);

// EXTERNAL MODULE: ./src/utils/index.js
var utils = __webpack_require__(7);

// EXTERNAL MODULE: ./src/pages-backstage/authorized/index.css?modules
var authorizedmodules = __webpack_require__(20);
var authorizedmodules_default = /*#__PURE__*/__webpack_require__.n(authorizedmodules);

// CONCATENATED MODULE: ./src/pages-backstage/authorized/index.js
function _slicedToArray(arr,i){return _arrayWithHoles(arr)||_iterableToArrayLimit(arr,i)||_unsupportedIterableToArray(arr,i)||_nonIterableRest();}function _nonIterableRest(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}function _unsupportedIterableToArray(o,minLen){if(!o)return;if(typeof o==="string")return _arrayLikeToArray(o,minLen);var n=Object.prototype.toString.call(o).slice(8,-1);if(n==="Object"&&o.constructor)n=o.constructor.name;if(n==="Map"||n==="Set")return Array.from(o);if(n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))return _arrayLikeToArray(o,minLen);}function _arrayLikeToArray(arr,len){if(len==null||len>arr.length)len=arr.length;for(var i=0,arr2=new Array(len);i<len;i++){arr2[i]=arr[i];}return arr2;}function _iterableToArrayLimit(arr,i){var _i=arr&&(typeof Symbol!=="undefined"&&arr[Symbol.iterator]||arr["@@iterator"]);if(_i==null)return;var _arr=[];var _n=true;var _d=false;var _s,_e;try{for(_i=_i.call(arr);!(_n=(_s=_i.next()).done);_n=true){_arr.push(_s.value);if(i&&_arr.length===i)break;}}catch(err){_d=true;_e=err;}finally{try{if(!_n&&_i["return"]!=null)_i["return"]();}finally{if(_d)throw _e;}}return _arr;}function _arrayWithHoles(arr){if(Array.isArray(arr))return arr;}/* harmony default export */ var authorized = (function(props){var query=props.location.query;var ref=Object(react["useRef"])();var _useState=Object(react["useState"])(''),_useState2=_slicedToArray(_useState,2),name=_useState2[0],setName=_useState2[1];var _useState3=Object(react["useState"])(false),_useState4=_slicedToArray(_useState3,2),loading=_useState4[0],setLoading=_useState4[1];var _useState5=Object(react["useState"])(''),_useState6=_slicedToArray(_useState5,2),password=_useState6[0],setPassword=_useState6[1];var handleChange=Object(react["useCallback"])(function(type,_ref){var value=_ref.detail.value;console.log(value);var set=type==='name'?setName:setPassword;set(value);},[name,password]);var handleLogin=Object(react["useCallback"])(function(){var params={name:name,password:sha1_default()(password)};setLoading(true);Object(utils["a" /* request */])('/auth',params).then(function(_ref2){var data=_ref2.data;Object(wechat_esm["w" /* setStorageSync */])('user_info',JSON.stringify(data));setLoading(false);if(query.redirect){Object(wechat_esm["t" /* redirectTo */])({url:query.redirect});}else{Object(wechat_esm["q" /* navigateBack */])();}}).catch(function(_ref3){var message=_ref3.message;ref.current&&ref.current.error(message);setLoading(false);});},[name,password]);return/*#__PURE__*/react_default.a.createElement(wechat_esm["h" /* View */],{className:authorizedmodules_default.a.body},/*#__PURE__*/react_default.a.createElement(ling["a" /* default */],{ref:ref}),/*#__PURE__*/react_default.a.createElement(wechat_esm["h" /* View */],{className:authorizedmodules_default.a.loginBox},/*#__PURE__*/react_default.a.createElement(wechat_esm["h" /* View */],{className:authorizedmodules_default.a.title},/*#__PURE__*/react_default.a.createElement(wechat_esm["g" /* Text */],null,"\u6B22\u8FCE\u4F7F\u7528")),/*#__PURE__*/react_default.a.createElement(wechat_esm["h" /* View */],{className:authorizedmodules_default.a.label},/*#__PURE__*/react_default.a.createElement(wechat_esm["g" /* Text */],null,"\u7528\u6237\u540D")),/*#__PURE__*/react_default.a.createElement(wechat_esm["h" /* View */],{className:authorizedmodules_default.a.input},/*#__PURE__*/react_default.a.createElement(wechat_esm["d" /* Input */],{value:name,onInput:handleChange.bind(null,'name')})),/*#__PURE__*/react_default.a.createElement(wechat_esm["h" /* View */],{className:authorizedmodules_default.a.label},/*#__PURE__*/react_default.a.createElement(wechat_esm["g" /* Text */],{className:authorizedmodules_default.a.label},"\u5BC6\u7801")),/*#__PURE__*/react_default.a.createElement(wechat_esm["h" /* View */],{className:authorizedmodules_default.a.input},/*#__PURE__*/react_default.a.createElement(wechat_esm["d" /* Input */],{password:true,value:password,onInput:handleChange.bind(null,'password')})),/*#__PURE__*/react_default.a.createElement(wechat_esm["a" /* Button */],{loading:loading,disabled:!name||!password,className:authorizedmodules_default.a.btn,type:"primary",onTap:handleLogin},"\u767B\u5F55")));});
// CONCATENATED MODULE: ./src/pages-backstage/authorized/index.entry.js
__webpack_require__(64);Page(Object(esm["f" /* createPageConfig */])(authorized,'pages-backstage/authorized/index'));
